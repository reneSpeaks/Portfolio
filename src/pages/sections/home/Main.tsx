...
export default function Main() {
	...
	return (
		<main className="text-primary-100 sticky top-0 z-10 flex h-dvh w-full justify-center place-self-start self-center overflow-x-hidden transition-transform duration-500 ease-in-out sm:p-4">
				...
				<motion.div
					...
					<h1 className="relative z-12 text-5xl font-semibold tracking-tight sm:text-7xl">
						...
						<motion.svg
							...
							className="drop-shadow-dark group pointer-events-auto absolute -top-3 -left-2 z-12 h-8 w-8 transform cursor-pointer drop-shadow-xs sm:-top-4 sm:-left-3 sm:h-12 sm:w-12">
							<defs>
								<linearGradient
									id="cap-main-gradient"
									x1="100.85"
									y1="73.23"
									x2="139.26"
									y2="73.23"
								...
								<linearGradient
									id="cap-main-gradient1"
									x1="18.21"
									y1="44.29"
									x2="111.34"
									y2="44.29"
									xlinkHref="#cap-main-gradient"
								/>
								<linearGradient
									id="cap-main-hover-gradient"
									x1="100.85"
									y1="73.23"
									x2="139.26"
									y2="73.23"
								...
								<linearGradient
									id="cap-main-hover-gradient1"
									x1="18.21"
									y1="44.29"
									x2="111.34"
									y2="44.29"
									xlinkHref="#cap-main-hover-gradient"
								/>
							</defs>
							<path
								className="transition-all duration-300 group-hover:fill-[url(#cap-main-hover-gradient)] group-hover:stroke-[var(--color-primary-200)]"
								stroke="var(--color-primary-100)"
								strokeWidth=".25px"
								strokeMiterlimit="10"
								fill="url(#cap-main-gradient)"
							...
							/>
							<path
								className="transition-all duration-300 group-hover:fill-[url(#cap-main-hover-gradient1)] group-hover:stroke-[var(--color-primary-200)]"
								stroke="var(--color-primary-100)"
								strokeWidth=".25px"
								strokeMiterlimit="10"
								fill="url(#cap-main-gradient1)"
