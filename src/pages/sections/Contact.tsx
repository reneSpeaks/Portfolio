				...
				<motion.div
					...
					<div className="flex w-7/10 flex-col">
						...
						<p className="mt-5 text-justify">
							...
							guy who likes being creative and challenges himself with web-technologies both{' '}
							...
							<br />
							When not working with code or playing around with designs, I enjoy creating rich fantasy worlds for my friends
